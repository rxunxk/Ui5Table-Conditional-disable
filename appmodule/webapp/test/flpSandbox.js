		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comraunakappmodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comraunakappmodule-display": {
								"semanticObject": "comraunakappmodule",
								"action": "display",
								"description": "A Fiori Application running locally",
								"title": "Application Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.raunak.appmodule",
									"url": sap.ui.require.toUrl("com/raunak/appmodule")
								}
							}
						}
					}
